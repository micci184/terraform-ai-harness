...
Copy this directory when creating a new State boundary root module.

Example targets:

```text
terraform/env/dev/global/edge
terraform/env/dev/ap-northeast-1/network
terraform/env/dev/ap-northeast-1/app
terraform/env/dev/ap-northeast-1/data
```
